...
Ambient Motion：待机也会驱动呼吸、眼球、头部 X/Y/Z、身体 X/Y/Z 以及绘梦模型的第二、第三层
躯干扭转参数。多组非整数频率曲线形成缓慢重心变化，并间歇叠加侧倾或抬头；开口后动作活跃度
平滑提高，PCM RMS 的短时上升会触发短促的强调姿势，而不是只改变嘴型。指数阻尼负责待机、说话
