...
\node[font=\large] at (0,0) {$(I-\gamma P_\pi)V^\pi=R_\pi,\qquad
      \pi^+(s)=\arg\max_a\left[R(s,a)+\gamma P_aV^\pi\right]$};
\node[stage] at (0,-.75) {策略迭代交替精确/近似评估当前策略，再用动作价值逐状态改进策略};
\DenseBlock{obj0}{-11.50}{-1.45}{4}{4}{roleTeal}{$P_\pi$}{$S\times S$}
\DenseBlock{obj1}{-5.75}{-1.45}{4}{1}{roleOrange}{$R_\pi$}{$S\times1$}
\DenseBlock{obj2}{0.00}{-1.45}{4}{1}{roleViolet}{$V^\pi$}{$S\times1$}
\DenseBlock{obj3}{5.75}{-1.45}{4}{3}{roleCoral}{$Q^\pi$}{$S\times A$}
\DenseBlock{obj4}{11.50}{-1.45}{4}{1}{roleGray}{$\pi^+$}{$S\times1$ 动作 ID}
\node[op] at (-8.63,-2.25) {$\operatorname{solve}$};
\node[op] at (-2.88,-2.25) {$\longrightarrow$};
\node[op] at (2.88,-2.25) {$\xrightarrow{R+\gamma P_aV}$};
\node[op] at (8.63,-2.25) {$\arg\max_A$};
\MeaningBox{S 是状态轴，A 是动作轴；策略评估只保留状态价值，策略改进临时展开动作轴。}
{V 与 Q 是价值分数，pi 是每状态的离散动作选择；不能把 argmax 结果当作价值。}
{每次贪心改进都不降低策略价值；有限 MDP 中反复评估与改进最终到达最优策略。}
\Identity{策略迭代的评估与改进}
