...
\node[font=\large] at (0,0) {$\hat y=X\theta,\quad r=\hat y-y,\quad
      g=X^\top r,\quad \theta^{(t+1)}=\theta^{(t)}-\alpha g$};
\node[stage] at (0,-.75) {一次批量梯度下降：前向预测、计算残差、聚合参数梯度，再更新同形参数};
\DenseBlock{obj0}{-11.50}{-1.45}{5}{3}{roleTeal}{$X$}{$m\times n$}
\DenseBlock{obj1}{-5.75}{-1.45}{3}{1}{roleOrange}{$\theta^{(t)}$}{$n\times1$}
\DenseBlock{obj2}{0.00}{-1.45}{5}{1}{roleViolet}{$r=X\theta-y$}{$m\times1$}
\DenseBlock{obj3}{5.75}{-1.45}{3}{1}{roleCoral}{$g=X^\top r$}{$n\times1$}
\DenseBlock{obj4}{11.50}{-1.45}{3}{1}{roleOrange}{$\theta^{(t+1)}$}{$n\times1$}
\node[op] at (-8.63,-2.25) {$\times$};
\node[op] at (-2.88,-2.25) {$-y$};
\node[op] at (2.88,-2.25) {$X^\top\times$};
\node[op] at (8.63,-2.25) {$-\alpha g$};
\MeaningBox{$m$ 是样本轴，$n$ 是参数轴；$X^\top r$ 消去样本轴，得到与参数完全同形的梯度。}
{$r$ 是逐样本有符号误差，$g$ 是参数空间的上升方向，$\alpha$ 是步长而非模型参数。}
{Batch 每步归约全部样本；SGD 只取一行，Mini-batch 取一组行，但四段计算链保持相同。}
