...
\node[font=\large] at (0,0) {$Z=X_cU_k,\qquad \hat X=ZU_k^\top,\qquad
      U_k^\top U_k=I_k$};
\node[stage] at (0,-.75) {PCA 用正交主轴把中心化数据压缩到 k 维，再用转置基重建回原特征空间};
\DenseBlock{obj0}{-11.50}{-1.45}{5}{4}{roleTeal}{$X_c$}{$m\times d$}
\DenseBlock{obj1}{-5.75}{-1.45}{4}{2}{roleOrange}{$U_k$}{$d\times k$}
\DenseBlock{obj2}{0.00}{-1.45}{5}{2}{roleViolet}{$Z$}{$m\times k$}
\DenseBlock{obj3}{5.75}{-1.45}{2}{4}{roleOrange}{$U_k^\top$}{$k\times d$}
\DenseBlock{obj4}{11.50}{-1.45}{5}{4}{roleCoral}{$\hat X$}{$m\times d$}
\node[op] at (-8.63,-2.25) {$\times$};
\node[op] at (-2.88,-2.25) {$=$};
\node[op] at (2.88,-2.25) {$\times$};
\node[op] at (8.63,-2.25) {$=$};
\MeaningBox{$m$ 是样本轴，$d$ 是原特征轴，$k<d$ 是主成分轴；转置真实交换 $d,k$ 边。}
{$U_k$ 的列是正交主方向，$Z$ 是低维坐标，$\hat X$ 是秩至多为 $k$ 的重建。}
{编码收缩 $d$，解码收缩 $k$；选择最大特征值方向同时最大化保留方差并最小化重建误差。}
