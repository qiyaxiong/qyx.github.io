...
- [多模态图片分析：从“看见”到可验证结论](/notes/ai/multimodal-image-analysis)：观察 Content 与 Harness 怎样共同约束一项具体任务。
- [Pi Agent 深度解析](/blog/pi-agent-deep-dive)：理解极简 Agent 内核、插件边界、工具执行与可靠性机制。
